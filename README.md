...
- 🕹️ **[Try zelph in your browser](https://acrion.github.io/zelph/play/)** – the complete reasoning engine as WebAssembly, no installation required. (Bleeding edge from `main`: [GitHub Pages playground](https://acrion.github.io/zelph/play/).)
